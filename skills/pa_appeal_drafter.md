...
Build search queries from Input **denial_reasons** and **case_data**. Pass the query to `search_pubmed(query=...)` to support appeal arguments. Use denial reasons and case facts from the Input.
